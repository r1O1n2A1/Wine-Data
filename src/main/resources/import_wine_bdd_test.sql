CREATE DATABASE  IF NOT EXISTS `wine_bdd_test` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `wine_bdd_test`;
-- MySQL dump 10.13  Distrib 5.7.12, for Win64 (x86_64)
--
-- Host: localhost    Database: wine_bdd_test
-- ------------------------------------------------------
...
-- Dump completed on 2017-03-29 18:10:29
CREATE DATABASE  IF NOT EXISTS `wine_bdd_test` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `wine_bdd_test`;
-- MySQL dump 10.13  Distrib 5.7.12, for Win64 (x86_64)
--
...
-- Dump completed on 2017-03-29 18:10:27
CREATE DATABASE  IF NOT EXISTS `wine_bdd_test` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `wine_bdd_test`;
-- MySQL dump 10.13  Distrib 5.7.12, for Win64 (x86_64)
--
...
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
INSERT INTO 'comment' VALUES (1,'2017-01-01 00:00:00',1,'commentaire test', 'Titre Test', 1,2);
/*!40101 SET SQL_MODE=@OLD_SQL_MODE */;
/*!40014 SET FOREIGN_KEY_CHECKS=@OLD_FOREIGN_KEY_CHECKS */;
/*!40014 SET UNIQUE_CHECKS=@OLD_UNIQUE_CHECKS */;
/*!40101 SET CHARACTER_SET_CLIENT=@OLD_CHARACTER_SET_CLIENT */;
...
-- Dump completed on 2017-03-29 18:10:25
CREATE DATABASE  IF NOT EXISTS `wine_bdd_test` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `wine_bdd_test`;
-- MySQL dump 10.13  Distrib 5.7.12, for Win64 (x86_64)
--
...
-- Dump completed on 2017-03-29 18:10:28
CREATE DATABASE  IF NOT EXISTS `wine_bdd_test` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `wine_bdd_test`;
-- MySQL dump 10.13  Distrib 5.7.12, for Win64 (x86_64)
--
...
-- Dump completed on 2017-03-29 18:10:26
CREATE DATABASE  IF NOT EXISTS `wine_bdd_test` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `wine_bdd_test`;
-- MySQL dump 10.13  Distrib 5.7.12, for Win64 (x86_64)
--
...
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
INSERT INTO 'ordering' VALUES (1, '2017-03-23 17:44:04', '2017-03-23 17:19:37', 2,1,1);
/*!40101 SET SQL_MODE=@OLD_SQL_MODE */;
/*!40014 SET FOREIGN_KEY_CHECKS=@OLD_FOREIGN_KEY_CHECKS */;
/*!40014 SET UNIQUE_CHECKS=@OLD_UNIQUE_CHECKS */;
/*!40101 SET CHARACTER_SET_CLIENT=@OLD_CHARACTER_SET_CLIENT */;
